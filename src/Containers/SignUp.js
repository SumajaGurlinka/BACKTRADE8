    ...
    formValues.lastname.error
      ...
      : ""
            ...
            InputProps={{
              endAdornment: (
                <InputAdornment position="end">
                  <Button style={{color:"grey",position: "absolute", right: "5px", }} onClick={handleAddGmailClick}>
                    <AddIcon/>
                  </Button>
                </InputAdornment>
              ),
          ...
          <TextField
            ...
            onChange={handleChange}
            required
            error={formValues.password.error|| (formValues.password.value.length > 0 && formValues.password.value.length < 6) }
            helperText={
              formValues.password.error
                ? formValues.password.errorMessage
                :  formValues.password.value.length > 0 && formValues.password.value.length < 6
